...
describe('That test case verified delete dashboard functionality:', function () {
    ...
    it('Verify that create dashboard', function () {
        ...
        browser.wait(OnBoarding.titleIs('Maestrano - Dashboard - Welcome'), browser.params.elementWait).then(function onboardingPageExists() {
